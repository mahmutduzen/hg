        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    {!! Form::model($slider,['route'=>['sliderler.update',$slider->id],'method'=>'PUT','class'=>'form-horizontal']) !!}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="textarea1 span11" name="bilgiler" rows="6">{{$slider->bilgiler}}</textarea>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">Sıra :</label>
                        <div class="controls">
                            <input type="text" class="span11" name="sira" value="{{$slider->sira}}"/>
                        </div>
                    </div>
