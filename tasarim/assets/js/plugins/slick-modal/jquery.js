...
!function (o) {
  o.fn.slickModals = function (i) {
    ...
    return this.each(function () {
      ...
      function d() {
        days = n.cookieDays, CookieDate = new Date(), days > 0 && (CookieDate.setTime(CookieDate.getTime() + 24 * days * 60 * 60 * 1000), document.cookie = n.cookieName + '=true; expires=' + CookieDate.toGMTString()), 0 === days && (document.cookie = n.cookieName + '=true;');
      }
      var r = this;
